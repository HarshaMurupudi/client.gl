  ...
  return (
    <>
      ...
      <div style={{ padding: '1rem' }} ref={contentToPrint}>
            ...
            <Grid.Col span={4} key={i}>
              {row.map((key, j) => (
                <Text component='p' key={j}>
                  <Text span>{mapKeyToLabel[key]}:</Text>
        ...
        <div>
          <p>
            1.) General Label certifies that the products in this shipment were
            produced either from materials furnished by the // customer or from
            the materials listed below on this document.
          </p>
          <p>
          ...
          <p>
            ...
            shipment conform to all customer purchase order // requirements and
          ...
          <p>
            ...
            shipment are Compliant with EU REACH Regulation // EC No. 1907/2006
            and EU REACH 211 SVHC 01/19/2021.
          </p>
        </div>
